...
Info:
This is a production-ready Fabric mod with existing users called Can't Sleep. The mod occasionally blocks bed usage on unlucky nights and stays configurable and predictable for everyone. Please ensure consistent, clear, and easy to understand changes. Always talk to me about important considerations, backwards compat, and other key points.
